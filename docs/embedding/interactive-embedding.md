...
```
https://data.engeem.com.example.com/auth/sso?return_to=http%3A%2F%2Fmetabase.yourcompany.com%2Fdashboard%2F1
```
...
```
https://data.engeem.com.example.com/auth/sso?jwt=<token>&return_to=%2Fdashboard%2F1
```
...
```
https://data.engeem.com.example.com/auth/sso?jwt=<token>&redirect=%2Fdashboard%2F1%3Ffilter1%3Dvalue%26filter2%3Dvalue
```
...
```sh
https://data.engeem.com.yourcompany.com/auth/logout
```
