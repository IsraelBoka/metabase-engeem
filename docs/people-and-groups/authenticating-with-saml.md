...
For example, if your Metabase Site URL is `https://data.engeem.com.yourcompany.com`, you'll use `https://data.engeem.com.yourcompany.com/auth/sso/` as the redirect URL in your IdP's SAML form.
